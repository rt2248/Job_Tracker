...
export default function MiniKanban() {
  ...
  return (
    <div className="w-full overflow-x-auto p-4 bg-surface border border-indigo/18 rounded-2xl font-body shadow-[0_0_0_1px_rgba(99,102,241,0.18),0_40px_80px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.04)]">
      <div className="flex gap-2.5 min-w-[440px] md:min-w-0">
        {cols.map(col => {
