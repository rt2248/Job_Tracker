...
export default function AutomationCTA() {
  return (
    <section className="mx-4 sm:mx-8 lg:mx-auto mb-16 sm:mb-24 lg:mb-[120px] max-w-[1160px] rounded-2xl sm:rounded-3xl border border-indigo/18 p-6 sm:p-10 lg:p-20 relative overflow-hidden bg-gradient-to-br from-surface via-indigo/[0.08] to-surface">
      {/* BG decoration */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-[60px] items-center relative z-[1]">
        <div>
          <h2 className="font-display text-[clamp(26px,3vw,44px)] font-extrabold tracking-[-0.03em] text-ink mb-4">
            Part of a larger<br />
            <span className="bg-gradient-to-br from-indigo to-cyan bg-clip-text text-transparent">
              automation ecosystem.
            </span>
          </h2>
          <p className="text-sm sm:text-base text-muted-light leading-[1.7] mb-8 max-w-[500px]">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link to="/signup" className="px-[26px] py-[13px] rounded-[10px] text-sm font-semibold bg-gradient-to-br from-indigo to-[#4338ca] border-none text-white cursor-pointer font-body transition-shadow duration-200 text-center shadow-[0_0_30px_rgba(99,102,241,0.3)] hover:shadow-[0_0_50px_rgba(99,102,241,0.5)]">
              Get started free
            </Link>
            <button className="px-[26px] py-[13px] rounded-[10px] text-sm font-medium bg-transparent border border-indigo/18 text-muted-light cursor-pointer font-body transition-all duration-200 hover:border-indigo/45 hover:text-ink text-center">
              Read the docs →
            </button>
          </div>
        </div>
        ...
        {/* Code snippet */}
        <div className="bg-[#020817] rounded-[14px] border border-indigo/18 p-5 sm:px-7 sm:py-6 font-mono text-xs leading-[1.7] w-full lg:min-w-[300px] overflow-x-auto shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
