...
const TopBar = ({ toggleSidebar }) => {
    return (
        <div className="h-[8vh] shrink-0 border-b border-b-ink/10 bg-surface/50 flex items-center justify-between px-4 transition-all duration-300 ease-in-out">
            ...
            <div className="flex flex-row items-center gap-4">
                <img src={notification} className="h-8 w-8 m-2 p-1 bg-indigo/10 border border-ink/20 hover:cursor-pointer hover:bg-indigo/20 hover:border-ink/30 rounded-lg transition-all ease-linear" />
